...
//initializing gestures strings
const gestureStrings = {};

//intializing array of gesture functions
const knownGestures = [];

// for to add all gestures
for (var gesture in gestures) {

  //Add in gestureStrings name of gesture and the emoji
  gestureStrings[gesture] = gestures[gesture].emoji;

  //Add in knownGestures the function of gesture
  knownGestures.push(gestures[gesture].gesture);
}
